...
***
C     GET THE CROSS SECTION IN 'barn/ster/MeV'
***
      SIGMA=10.0*SIG/FMMEV/1000.
      RADMOTT=SIGMA
C      WRITE(6,1000) E0,eloss,THET,SIGMA
 1000    FORMAT(5X,'E0 =',E13.5,'  GeV',4X,'E left=',E10.3
     +    ,5X,'theta =',E11.4
     +    ,5X,'SIGMA =', E11.4,'  barn/ster/MeV')
 100  CONTINUE
      END
C
